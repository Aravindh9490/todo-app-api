...
// converting todo table database to json response data
...
//date format, formatting with date-fns/
...
// API 1 Invalid scenarios of all APIs
...
// API 3 Returns a list of all todos with a specific due date in the query parameter `/agenda/?date=2021-12-12` using GET Method
...
// API 4 Create a todo in the todo table, using POST Method
...
// API 5 Updates the details of a specific todo based on the todo ID using PUT method
...
//API 6 Deletes a todo from the todo table based on the todo ID using DELETE method
